...
function conection(status) {
  ...
  const conecion = ESTADOS[conectividad] || DESCONECTADO
  return conecion
}
...
function saludo(idioma) {
  ...
  const saludar = IDIOMA[idiomaIngresado] || ESPANOL
  return saludar
}
...
// console.log(obtenerMayor(100, 100));
...
// console.log(tieneTresDigitos(3440));
