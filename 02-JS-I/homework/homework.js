...
function esVocal(letra){
  ...
  let vocal = letraMinuscula;
  if (vocales.indexOf(vocal) === -1 || vocal.length >= 2) {
...
// console.log(devolverString("hola como estas"))
...
// console.log(tienenMismaLongitud("hola", "holaa")); 
...
// console.log(elevar(10, 5));
// console.log(redondearNumero(3.63));
// console.log(redondearHaciaArriba(2.0002));
// console.log(numeroRandom());
// console.log(esPositivo(2));
// console.log(agregarSimboloExclamacion("Hola Mundo"));
// console.log(combinarNombres("Fede", "Ponce"));
// console.log(obtenerSaludo("Federico"));
// console.log(obtenerAreaRectangulo(10, 20));
// console.log(retornarPerimetro(2));
// console.log(areaDelTriangulo(20, 30));
// console.log(deEuroAdolar(19));
